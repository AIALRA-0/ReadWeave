...
describe("formatAttrForSearch value quoting (formatValue)", () => {
    ...
    it("escapes double quotes inside the canonical double-quoted form", () => {
        expect(formatAttrForSearch(label("v", 'say "hi"'), true)).toBe('#v="say \\"hi\\""');
    });

    it("keeps apostrophes literal while escaping double quotes", () => {
    ...
    it("escapes backslashes before quotes", () => {
        expect(formatAttrForSearch(label("example", 'path\\with"quote'), true))
