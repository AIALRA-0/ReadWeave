...
function register(app: express.Application) {
    ...
    apiRoute(PST, "/api/readweave/harness/:versionId/trial", readweaveRoute.trialHarness);
    apiRoute(GET, "/api/readweave/harness/:versionId/trial", readweaveRoute.getLatestHarnessTrial);
    apiRoute(GET, "/api/readweave/harness/trials/:trialJobId", readweaveRoute.getHarnessTrial);
    ...
    apiRoute(PST, "/api/readweave/generation-jobs/:jobId/commit", readweaveRoute.commitGenerationJob);
