...
/** Complete entry and normative references, shared by writing and format repair.
 * Runtime boundaries separate the writing rules from local development commands. */
