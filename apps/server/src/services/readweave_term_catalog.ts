...
export const KNOWN_PRODUCT_CANONICAL_FORMS = new Map([
    ...
    [ "ARB/MUX", "ARB/MUX 仲裁与多路复用（Arbitration and Multiplexing）" ],
    [ "Apple", "苹果公司（Apple）" ],
    ...
    [ "CRC", "CRC 循环冗余校验（Cyclic Redundancy Check）" ],
    ...
    [ "I/O", "I/O 输入输出（Input/Output）" ],
    [ "PAM-4", "PAM-4 四电平脉冲幅度调制（Four-Level Pulse Amplitude Modulation）" ],
    ...
    [ "DLLP", "DLLP 数据链路层数据包（Data Link Layer Packet）" ],
    ...
    [ "FLIT", "FLIT 流控制单元（Flow Control Unit）" ],
    ...
    [ "TLP", "TLP 事务层数据包（Transaction Layer Packet）" ],
    ...
    [ "PCI Express", "PCIe 高速外设组件互连（Peripheral Component Interconnect Express）" ],
