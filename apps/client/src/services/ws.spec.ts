...
describe("WebSocket transport", () => {
    ...
    it("does not connect or retry before the initial password is set", async () => {
        lastSocket = undefined as unknown as FakeSocket;
        (window as unknown as { glob: Record<string, unknown> }).glob = { ...baseGlob, dbInitialized: true, passwordSet: false };
