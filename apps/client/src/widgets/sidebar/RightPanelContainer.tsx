...
function useSplit(visible: boolean) {
    ...
    useEffect(() => {
        ...
        const splitInstance = Split(["#center-pane", "#right-pane"], {
            ...
            // ReadWeave is a working surface (questions, definitions and impact
            // previews), so the right pane must stay usable at its minimum size.
            minSize: [300, MIN_RIGHT_PANE_WIDTH],
            rtl: glob.isRtl,
